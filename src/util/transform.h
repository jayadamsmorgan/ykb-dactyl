...
// A rotation and translation. The rotations are applied first in z,x,y order
...
// applied in order. If you are looking at a shape which has been placed by a
// transform list and you want to rotate it in place, the transform you add
