...
public:
    ...
    explicit Shape(ScadWriter scad)
        : scad_(std::make_shared<ScadWriter>(std::move(scad))) {}

    static Shape Composite(const std::function<void(std::FILE *)> &write_name,
                           const std::vector<Shape> &shapes);
    static Shape LiteralComposite(const std::string &name,
                                  const std::vector<Shape> &shapes);
    ...
    Shape SCAD_WARN_UNUSED_RESULT MirrorY() const { return Mirror(0, 1, 0); }
    Shape SCAD_WARN_UNUSED_RESULT MirrorX() const { return Mirror(1, 0, 0); }

    Shape SCAD_WARN_UNUSED_RESULT Rotate(double rx, double ry, double rz) const;
    Shape SCAD_WARN_UNUSED_RESULT Rotate(double degrees, double x, double y,
                                         double z) const;
    ...
    Shape SCAD_WARN_UNUSED_RESULT
    LinearExtrude(const LinearExtrudeParams &params) const;
    Shape SCAD_WARN_UNUSED_RESULT LinearExtrude(double height) const;

    Shape SCAD_WARN_UNUSED_RESULT Color(double r, double g, double b,
                                        double a = 1.0) const;
    Shape SCAD_WARN_UNUSED_RESULT Color(const std::string &color,
                                        double a = 1) const;
    ...
    Shape SCAD_WARN_UNUSED_RESULT OffsetRadius(double r,
                                               bool chamfer = false) const;
    Shape SCAD_WARN_UNUSED_RESULT OffsetDelta(double delta,
                                              bool chamfer = false) const;
...
Shape SCAD_WARN_UNUSED_RESULT Cube(double x, double y, double z,
                                   bool center = true);
...
Shape SCAD_WARN_UNUSED_RESULT Cylinder(double height, double radius,
                                       Optional<double> fn = {});
...
Shape SCAD_WARN_UNUSED_RESULT
Polyhedron(const std::vector<Point3d> &points,
           const std::vector<std::vector<int>> &faces, int convexity = 1);

Shape SCAD_WARN_UNUSED_RESULT HullAll(const std::vector<Shape> &shapes);

template <typename... Shapes>
Shape SCAD_WARN_UNUSED_RESULT Hull(const Shape &shape,
                                   const Shapes &...more_shapes) {
...
template <typename... Shapes>
Shape SCAD_WARN_UNUSED_RESULT Union(const Shape &shape,
                                    const Shapes &...more_shapes) {
...
template <typename... Shapes>
Shape SCAD_WARN_UNUSED_RESULT Difference(const Shape &shape,
                                         const Shapes &...more_shapes) {
...
template <typename... Shapes>
Shape SCAD_WARN_UNUSED_RESULT Intersection(const Shape &shape,
                                           const Shapes &...more_shapes) {
    return IntersectionAll({shape, more_shapes...});
}

Shape SCAD_WARN_UNUSED_RESULT Import(const std::string &file_name,
                                     int convexity = -1);

Shape SCAD_WARN_UNUSED_RESULT Minkowski(const Shape &first,
                                        const Shape &second);
