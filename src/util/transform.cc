...
glm::vec3 Transform::Apply(const glm::vec3 &p) const {
    ...
    transform =
        glm::rotate(transform, glm::radians((float)ry), glm::vec3(0, 1, 0));
    transform =
        glm::rotate(transform, glm::radians((float)rx), glm::vec3(1, 0, 0));
    transform =
        glm::rotate(transform, glm::radians((float)rz), glm::vec3(0, 0, 1));
